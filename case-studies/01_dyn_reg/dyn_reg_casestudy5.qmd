...
citation:
  ...
  url: https://davkoh.github.io/case-studies/01_dyn_reg/dyn_reg_casestudy5.html
  pdf-url: https://davkoh.github.io/case-studies/01_dyn_reg/dyn_reg_casestudy5.pdf
  issued: 2025-06-04
execute:
  cache: false
format:
...
This case study carries Google Scholar citation metadata in the page header, so it is indexed and citable in the same way as a working paper. Please cite the case study itself when you use the code or the results, and cite @kohns2025arr2 for the ARR2 prior it applies. The same entry is regenerated automatically at the foot of the page.
...
In text: Kohns, D. (2025). *Dynamic Regression Case Study*. Case Studies in Bayesian Nowcasting. Aalto University. <https://davkoh.github.io/case-studies/01_dyn_reg/dyn_reg_casestudy5.html>

Because the case study is updated over time, please record the access date, and where the exact version matters, cite the date shown as *Modified* at the top of the page.
